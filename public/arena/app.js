...
function classSpritePath(heroClass, faction) {
  ...
  if (cls === "MAGE") return "/arena/units/battle-mage-pixel.svg";
  if (cls === "RANGER") return "/arena/heroes/ranger-pixel.svg";
  if (cls === "HEALER") return "/arena/heroes/healer-pixel.svg";
  if (cls === "WARRIOR") return faction === "alliance" ? "/arena/heroes/warrior-pixel.svg" : "/arena/units/ogre-pixel.svg";
  return faction === "alliance" ? "/arena/heroes/warrior-pixel.svg" : "/arena/units/grunt-pixel.svg";
}

function unitSpritePath(type, faction) {
  const t = String(type || "").toUpperCase();
  if (t === "OGRE" || t === "OGRE_LORD") return "/arena/units/ogre-pixel.svg";
  if (t === "BATTLE_MAGE") return "/arena/units/battle-mage-pixel.svg";
  if (t === "PEASANT") return "/arena/units/peasant-pixel.svg";
  if (t === "GRUNT") return "/arena/units/grunt-pixel.svg";
  if (t === "DEATH_KNIGHT") return "/arena/units/death-knight-pixel.svg";
  if (t === "BALLISTA") return "/arena/units/ballista-pixel.svg";
  if (t === "FOOTMAN") return "/arena/units/footman-pixel.svg";
  if (t === "KNIGHT") return "/arena/units/knight-pixel.svg";
  if (t === "RIFLEMAN" || t === "ARCHER") return "/arena/heroes/ranger-pixel.svg";
  if (t === "TROLL" || t === "TROLL_AXER") return "/arena/units/troll-pixel.svg";
  if (t === "WOLF_RIDER") return "/arena/units/grunt-pixel.svg";
  if (t === "CATAPULT") return "/arena/units/ballista-pixel.svg";
  return faction === "alliance" ? "/arena/heroes/hero-placeholder.svg" : "/arena/units/grunt-pixel.svg";
}
...
function createMapRenderer(canvas) {
  ...
  const groundRings = [];
  const arena = loadSprite("/arena/terrain/fightclub-arena.svg");
  const structureSprites = {
    allianceTower: loadSprite("/arena/structures/alliance-tower.svg"),
    hordeTower: loadSprite("/arena/structures/horde-tower.svg"),
    allianceKeep: loadSprite("/arena/structures/alliance-keep.svg"),
    hordeKeep: loadSprite("/arena/structures/horde-keep.svg"),
    banner: loadSprite("/arena/structures/center-banner.svg"),
  };
