...
const server = http.createServer(async (req, res) => {
  ...
  // Serve docs
  if (pathname === "/docs" || pathname === "/docs/" || pathname === "/arena/docs") {
...
<body><a class="doc-back" href="/arena">&larr; Back to Arena</a><div class="doc-content"><pre style="white-space:pre-wrap;font-size:13px;line-height:1.6">${md.replace(/</g,"&lt;").replace(/>/g,"&gt;")}</pre></div></body></html>`;
  ...
  // Route: /arena → game UI, /arena/pvp → PvP mode
  // Route: / → landing page (original index.html)
  // Everything else → static files from public/
  let targetPath;
  if (pathname === "/arena" || pathname === "/arena/") {
    targetPath = "/arena/index.html";
  } else if (pathname === "/arena/pvp") {
    targetPath = "/arena/pvp.html";
  } else if (pathname === "/") {
